...
Flow.prototype.handleStatus = function(node,statusMessage) {
    var statMessage = { status : statusMessage };
            //text: statusMessage.text,
            //shape : statusMessage.shape,
            //fill : statusMessage.fill,
    statMessage.status.source = {
        id: node.id,
        type: node.type,
        name: node.name
    };
    statMessage.payload = statusMessage.text;   // TODO: should be the NLS'd version...
    //statMessage.payload = statusMessage.i18n;
